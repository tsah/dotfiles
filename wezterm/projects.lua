...
local project_roots = { "/Users/tsah/dev/git/", "/Users/tsah/dev/git/personal" }
...
local function project_dirs()
  ...
  for _, root_dir in ipairs(project_roots) do
    for _, dir in ipairs(wezterm.glob(root_dir .. '/*')) do
