...
rm -rf "$HOME/.config/opencode/skills/self-destruct"
ln -sf "$DOTFILES_DIR/claude/skills/self-destruct" "$HOME/.config/opencode/skills/self-destruct"

mkdir -p "$HOME/.claude/commands"
mkdir -p "$HOME/.claude/skills"
ln -sf "$DOTFILES_DIR/claude/commands/handoff.md" "$HOME/.claude/commands/handoff.md"
rm -f "$HOME/.claude/commands/tworker.md" "$HOME/.claude/commands/tw.md"
rm -rf "$HOME/.claude/skills/self-destruct"
rm -rf "$HOME/.claude/skills/tmux-worktree-worker"
rm -rf "$HOME/.claude/skills/tmux-interactive-control"
ln -sf "$DOTFILES_DIR/claude/skills/self-destruct" "$HOME/.claude/skills/self-destruct"
...
rm -rf "$HOME/.codex/skills/self-destruct"
ln -sf "$DOTFILES_DIR/claude/skills/self-destruct" "$HOME/.codex/skills/self-destruct"
...
rm -rf "$HOME/.pi/agent/skills/self-destruct"
ln -sf "$DOTFILES_DIR/claude/skills/self-destruct" "$HOME/.pi/agent/skills/self-destruct"
