...
keymap({ 'n', 'v' }, '<leader>oa', function() dofile(vim.fn.stdpath('config') .. '/lua/vd/opencode_tmux.lua').ask() end, { desc = 'Ask opencode (this project, pane→window) about selection' })
